...
const Hero = () => {
  return (
   <section>
    <div className=' min-h-screen max-w-[1250px] mx-auto px-10 flex flex-col  md:flex-row items-center md:pt-25 pt-35  '>

        {/* Hero content  */}
        <div className='flex-1'>
            <span className='bg-orange-100 text-orange-500 text-lg px-5 py-2 rounded-full'>Export Best Quality....</span>
            <h1 className='md:text-7xl/20 font-bold mt-4 text-5xl/14'>  
